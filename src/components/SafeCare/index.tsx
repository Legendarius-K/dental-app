...
const SafeCare = () => {
    ...
    return (
        <section ref={ref} className="bg-accent px-5 sm:px-10 lg:px-14 xl:px-28 py-24 flex justify-center pb-36">
            <div className="max-w-[1200px] flex flex-col gap-10">
                <div className='flex flex-col sm:flex-row gap-10 items-center'>
                    <div className=' sm:basis-1/2'>
                        <h2 className="text-darkbluegray text-3xl sm:text-5xl sm:mb-8 font-semibold text-center max-w-[500px]">Trygg och vänlig tandvård</h2>
                ...
                <div className='flex flex-col sm:flex-row gap-10'>
                    <div className=' sm:basis-1/2'>
                        <h2 className="text-darkbluegray text-3xl font-semibold text-center">Vi ses snart igen</h2>
                    ...
                    <div className=' sm:basis-1/2'>
                        <h2 className="text-darkbluegray text-3xl font-semibold text-center">Tandvårdsrädd?</h2>

        ...
        <section className="flex justify-center">
            <div className="w-full max-w-[1400px]">
                ...
                <div className="flex flex-col sm:flex-row p-4 pb-24  sm:p-10 sm:pb-28 mt-8">
                    <div className="flex flex-col justify-between w-full p-0 h-[440px]">
                    ...
                    <div className="box-border w-[100%] mt-12 sm:mt-0 rounded">
                        <iframe className="rounded-lg" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31818.04789364442!2d14.93595308845188!3d58.03183079054311!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x465987fd56607ce5%3A0x1f93fa2a89c6fcd!2zVHJhbsOlcw!5e1!3m2!1ssv!2sse!4v1727419806771!5m2!1ssv!2sse" width="100%" height="442" style={{ border: 0, }}></iframe>
                    </div>
                </div>
            </div>
        </section>

    ...
    return (
        <section className="flex flex-col md:flex-row bg-white max-h-[1000px]">
            <div className="basis-1/2 p-8 flex flex-col items-center justify-center">
                <h2 className="text-black text-4xl lg:text-4xl md:mb-8 text-center max-w-[800px]">Det får du för pengarna</h2>
                <div>
            ...
            <div className="basis-1/2 p-8 flex flex-col ">
                <h2 className="text-black text-4xl lg:text-4xl md:mb-8 text-center max-w-[800px]">Hitta en ledig tid</h2>

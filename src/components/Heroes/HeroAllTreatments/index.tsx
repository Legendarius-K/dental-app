...
const HeroAllTreatments = () => {
    return (
      <section
        className="relative w-full h-[620px] max-h-screen bg-cover bg-center text-neutral-100 font-sans"
      ...
      >
        ...
        <div className="ml-6 mr-6 md:ml-[80px] xl:ml-[130px]">
          ...
          <h2 className="relative z-20 md:text-lg max-w-[500px] pt-6 font-light">
            Upptäck vårt omfattande utbud av tandvårdstjänster för en frisk och
            strålande leende.
          </h2>
        </div>

...
const HeroAllTreatments = () => {
    return (
        <section
            className="relative w-full h-[650px] max-h-screen bg-cover bg-center text-neutral-100 font-sans"
            style={{ backgroundImage: "url('/images/hero-all-treatments.png')" }}
        >
            <div className="absolute inset-0 bg-black opacity-40 z-10"></div>
            <div className="ml-6 mr-6 md:ml-[80px] xl:ml-[130px]">
                <h1 className="relative z-20 text-5xl md:text-7xl max-w-[500px] pt-52 md:pt-[190px] font-nunito font-bold">Alla behandlingar</h1>
                <h2 className="relative z-20 md:text-lg max-w-[500px] pt-6 font-light">Upptäck vårt omfattande utbud av tandvårdstjänster för en frisk och strålande leende.</h2>
            </div>
...
export default HeroAllTreatments;

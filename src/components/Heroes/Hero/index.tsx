...
const Hero = () => {
    ...
    return (
      <section
        ...
        style={{ backgroundImage: "url('/images/hero-main2.jpeg')" }}
      >
        <div className="absolute inset-0 bg-black opacity-40 z-10"></div>
        <div className="absolute top-16 right-3 text-[8px] md:text-[9px] text-neutral-300 z-30 flex gap-[2px]">
          Allmäntandvård | Specialisttandvård | Tandreglering | <h1>Tandläkare Tranås</h1>
        </div>
        <div className="ml-6 mr-6 md:ml-[80px] xl:ml-[130px]">
          <h2 className="relative z-20 text-4xl md:text-6xl max-w-[500px] pt-52 md:pt-[190px] font-nunito font-bold">
            Tandvård för ett{" "}

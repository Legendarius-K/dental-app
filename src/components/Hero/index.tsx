    ...
    return (
        ...
        >
            ...
            <div className="flex z-30 absolute inset-x-0 bottom-0 h-32 md:h-16 flex-wrap md:flex-nowrap justify-around items-center text-pt-navyblue p-4 bg-pt-gray2 bg-neutral-100 text-neutral-800">
                <div className="w-[139px] md:w-auto  md:text-left mb-2 md:mb-0 text-sm md:text-[16px]">
                    <p>&#8226; Enkel bokning</p>
                </div>
                <div className="w-[139px] md:w-auto  md:text-right mb-2 md:mb-0 text-sm md:text-[16px]">
                    <p>&#8226; Kort väntetid</p>
                </div>
                <div className="w-[139px] md:w-auto  md:text-left text-sm md:text-[16px]">
                    <p>&#8226; Erfaren personal</p>
                </div>
                <div className="w-[139px] md:w-auto  md:text-right text-sm md:text-[16px]">
                    <p>&#8226; Nöjda kunder</p>
                </div>
            </div>
        </section>

    ...
    return (
        <div className="bg-darkbluegray basis-1/2">
            <div className="flex flex-col items-center  p-8">
                ...
                <p className="text-white font-sans lg:pt-4 sm:text-2xl  lg:max-w-[550px] text-justify">Varmt välkommen till oss på Trygg Tandvård. Vi har i dag 2 kliniker i Sverige. Om du vill <a href="" className="font-bold text-accent hover:text-darkblue">boka</a> om eller <a href="" className="font-bold text-accent hover:text-darkblue">boka ny tid</a> hos oss är du varmt välkommen att kontakta din klinik.</p>

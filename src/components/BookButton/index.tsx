...
const BookButton = ({ text, buttonStyle }: BookButtonProps) => {
    return (
        <Link href="/" className={`z-20 relative inline-flex items-center justify-start inline-block overflow-hidden transition-all duration-200 bg-mainblue rounded-full hover:bg-darkblue group ${buttonStyle}`}>

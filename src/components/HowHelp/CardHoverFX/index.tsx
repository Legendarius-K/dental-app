            ...
            {items.map((item, idx) => (
                ...
                >
                    <AnimatePresence>
                        {hoveredIndex === idx && (
                            <motion.span
                                className="absolute inset-0 h-full w-full bg-lightblue/50 dark:bg-mainblue/[0.4] block rounded-3xl"
...
export const Card = ({
    ...
    return (
        <div
            className={cn(
                "text-nowrap rounded-2xl h-full flex justify-center w-full p-4 overflow-hidden bg-lightblue/80 border border-transparent dark:border-white/[0.2] shadow-lg relative z-20",
                className
            )}
        >

...
const ContactButton = ({ text, buttonStyle }: ContactButtonProps) => {
    return (
        <Link href="/" className={`font-medium z-20 relative inline-flex items-center justify-start inline-block overflow-hidden transition-all bg-neutral-100 rounded-full hover:bg-neutral-400 group ${buttonStyle}`}>

...
const ContactButton = ({ text, buttonStyle }: ContactButtonProps) => {
    return (
        <Link href="/" className={`z-20 relative inline-flex items-center justify-start inline-block overflow-hidden transition-all duration-200 bg-neutral-100 rounded-full hover:bg-darkblue group ${buttonStyle}`}>

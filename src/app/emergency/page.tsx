                ...
                <div className="md:pt-16 flex flex-col items-center max-w-[1150px] p-6 md:p-10">
                    ...
                    <section className="w-full flex flex-col md:flex-row gap-16 my-10">
                        <div className="md:w-1/2 w-full flex flex-col gap-5 font-sans">
                            ...
                            <p><span className="font-semibold">När du råkar ut för akuta tandproblem</span> är det avgörande att få snabb och rätt hjälp. Oavsett om du lider av tandvärk, känsliga tänder eller en skadad tand eller fyllning, ska du inte behöva gå runt med smärta. Trygg Tandvård i Tranås erbjuder akut tandvård med flexibla öppettider, även kvällar och helger, utan extra avgifter.</p>
                            ...
                            <p><span className="font-semibold">Hos oss möts du av erfarna tandläkare och tandsköterskor</span> som använder den senaste tekniken. Även om du har tandvärk eller lider av tandläkarskräck, är vi experter på att skapa en behaglig och trygg upplevelse under hela ditt besök. Vi erbjuder samma pris oavsett dag eller tid på dygnet, så att du kan känna dig trygg när du besöker oss.</p>
                            <p><span className="font-semibold">Trygg Tandvård tillämpar inga extra avgifter för akut tandvård</span> på kvällar och helger, vilket innebär att priset är detsamma oavsett när du besöker oss.</p>
